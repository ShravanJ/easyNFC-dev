...
public class WriteMapActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final EditText latitudeEditText = (EditText)this.findViewById(R.id.latitudetext);
        final EditText longitudeEditText = (EditText)this.findViewById(R.id.longitudeedittext);
        ...
        writeMapButton.setOnClickListener(new android.view.View.OnClickListener() 
        {
        	public void onClick(View view) {
        		...
        		TextView messageText = (TextView)findViewById(R.id.latitudetext);
